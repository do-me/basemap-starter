...
public class Roads implements ForwardingProfile.LayerPostProcesser {
  ...
  public void processOsm(SourceFeature sf, FeatureCollector features) {
    if (sf.canBeLine() && sf.hasTag("highway") &&
      !(sf.hasTag("highway", "elevator"))) { // Removed the specific list of excluded tags.
      String kind = "other";
      String kindDetail = "";
      int minZoom = 15;
      int maxZoom = 15;
      ...
      // Pass through construction-related tags
      if (sf.hasTag("construction")) {
        feat.setAttr("construction", sf.getString("construction"));
      }
      if (sf.hasTag("proposed")) {
        feat.setAttr("proposed", sf.getString("proposed"));
      }
      if (sf.hasTag("razed")) {
        feat.setAttr("razed", sf.getString("razed"));
      }
      if (sf.hasTag("disused")) {
        feat.setAttr("disused", sf.getString("disused"));
      }
